...
#define FFMPEG_CONFIGURATION "--extra-libs=-lgcc --prefix=/Users/troy/Documents/GitRepo/ffmpegPlayground/app/jni/build/armeabi-v7a --cross-prefix=/Users/troy/Documents/ndk/android-ndk-r14b/toolchains/toolchain/bin/arm-linux-androideabi- --target-os=android --sysroot=/Users/troy/Documents/ndk/android-ndk-r14b/platforms/android-16/arch-arm/ --arch=arm --cpu=armv7-a --disable-debug --disable-doc --enable-asm --enable-neon --enable-ffmpeg --enable-cross-compile --enable-runtime-cpudetect --enable-hardcoded-tables --enable-libx264 --enable-pthreads --enable-network --enable-pic --disable-static --enable-shared --enable-avcodec --enable-avformat --enable-avdevice --enable-avfilter --enable-swresample --enable-avresample --enable-swscale --enable-small --disable-ffplay --disable-ffprobe --disable-symver --enable-indev=lavfi --disable-parsers --enable-parser=aac --enable-parser=h264 --enable-parser=mjpeg --enable-parser=png --enable-parser=bmp --enable-parser=mpegvideo --enable-parser=mpegaudio --disable-encoders --enable-encoder=libx264 --enable-encoder=mpeg4 --enable-encoder=aac --enable-encoder=png --enable-encoder=mjpeg --enable-encoder=gif --enable-encoder=bmp --enable-encoder=pcm_u8 --disable-decoders --enable-decoder=h264 --enable-decoder=hevc --enable-decoder=mpeg4 --enable-decoder=vp9 --enable-decoder=mp3 --enable-decoder=aac --enable-decoder=ac3 --enable-decoder=alac --enable-decoder=flac --enable-decoder=vorbis --enable-decoder=yuv4 --enable-decoder=mjpeg --enable-decoder=gif --enable-decoder=png --enable-decoder=bmp --enable-decoder=pcm_u8 --enable-decoder=pcm_s16le --disable-protocols --enable-protocol=async --enable-protocol=file --enable-protocol=data --enable-protocol=concat --enable-protocol=hls --enable-protocol=http --enable-protocol=https --disable-demuxers --enable-demuxer=h264 --enable-demuxer=flv --enable-demuxer=gif --enable-demuxer=image2 --enable-demuxer=aac --enable-demuxer=aiff --enable-demuxer=flac --enable-demuxer=wav --enable-demuxer=ogg --enable-demuxer=dts --enable-demuxer=mp3 --enable-demuxer=mov --enable-demuxer=m4v --enable-demuxer=matroska --enable-demuxer=concat --enable-demuxer=mpegts --enable-demuxer=mjpeg --enable-demuxer=mpegvideo --enable-demuxer=rawvideo --enable-demuxer=yuv4mpegpipe --disable-muxers --enable-muxer=h264 --enable-muxer=gif --enable-muxer=image2 --enable-muxer=matroska --enable-muxer=mp3 --enable-muxer=dts --enable-muxer=adts --enable-muxer=mp4 --enable-muxer=mpegts --disable-filters --enable-filter=aresample --enable-filter=amix --enable-filter=adelay --enable-filter=afade --enable-filter=aformat --enable-filter=atempo --enable-filter=volume --enable-filter=asetpts --enable-filter=setpts --enable-filter=setsar --enable-filter=setdar --enable-filter=showwavespic --enable-filter=scale --enable-filter=pad --enable-filter=concat --enable-filter=compand --enable-filter=drawbox --enable-filter=rotate --enable-filter=crop --enable-filter=anullsrc --enable-filter=transpose --enable-filter=hflip --enable-filter=vflip --extra-cflags='-mfloat-abi=softfp -mfpu=neon -marm -march=armv7-a' --extra-cxxflags=-I./compat --enable-encoder=aac --enable-decoder=aac --enable-gpl --enable-encoder=libx264 --enable-libx264 --extra-cflags=-I/Users/troy/Documents/GitRepo/ffmpegPlayground/app/jni/build/armeabi-v7a/include --extra-ldflags=-L/Users/troy/Documents/GitRepo/ffmpegPlayground/app/jni/build/armeabi-v7a/lib"
#define FFMPEG_LICENSE "GPL version 2 or later"
#define CONFIG_THIS_YEAR 2018
#define FFMPEG_DATADIR "/Users/troy/Documents/GitRepo/ffmpegPlayground/app/jni/build/armeabi-v7a/share/ffmpeg"
#define AVCONV_DATADIR "/Users/troy/Documents/GitRepo/ffmpegPlayground/app/jni/build/armeabi-v7a/share/ffmpeg"
